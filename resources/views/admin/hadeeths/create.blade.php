    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">Add New Hadeeth</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.hadeeths.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('arabic_text') is-invalid @enderror" 
                                              ...
                                              dir="rtl" style="font-family: 'Amiri', 'Times New Roman', serif; font-size: 18px;">{{ old('arabic_text') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('english_translation') is-invalid @enderror" 
                                              id="english_translation" name="english_translation" rows="6" required>{{ old('english_translation') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('display_date') is-invalid @enderror" 
                                           id="display_date" name="display_date" value="{{ old('display_date') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div id="arabic-preview" class="p-3 bg-white rounded border" 
                                                    ...
                                                    Enter Arabic text above to see preview
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div id="english-preview" class="p-3 bg-white rounded border" 
                                                    ...
                                                    Enter English translation above to see preview
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                            <small class="text-muted" id="reference-preview">Reference will appear here</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Save Hadeeth
                            </button>
                        </div>
                    </form>
                </div>
